...
class OhTest extends UnitAbstract
{
    ...
    public function testOh()
    {
     ...
     //create and test Oh API
        ...
        $this->assertContains('Alpha', $ohCreate['results'][0], 'The Value is not present in the array');
        ...
        $this->assertContains('Ohio', $update['results'][0], 'The Value does not exists in the record');
